...
OBJECTS = cjacobian.o ctaylor.o VBIC95Jac/VBIC95Jac.o LUFAC/lufac.o VBIC95/VBIC95.o \
	...
	test/test10.o test/test11.o test/test12.o test/test13.o test/test14.o
...
test/test.exe: test/test.o test/test0.o test/test1.o test/test2.o test/test3.o test/test4.o test/test5.o \
	test/test6.o test/test7.o test/test8.o test/test9.o test/test10.o test/test11.o test/test12.o test/test13.o test/test14.o
	$(CXX) $(CXXFLAGS) -o $@ $^
